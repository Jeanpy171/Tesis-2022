...
export default function RecoverPassword({navigation}) {
  ...
  const getDataUsingAsyncAwaitGetCall =  (email, password) => {
    axios
      .post('https://localhost:8000/api/v1/login', 
        { email, password }, { headers: { 'accept': 'application/json' }})
  ...
  const onLogin = async (email) => {
    ...
    try {
        ...
        const response = await axios.post(
            ...
            'https://alphao1.herokuapp.com/api/alpha/forgot-password',
            { email },
