  ...
  if (!fontsLoaded) {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{flexDirection:"row", bottom:"40%", justifyContent:"space-between",width:"80%",right:"7%"}}>
        <FAB 
        style={styles.edit}
        visible={true}
        //title="Editar"
        size='small'
        icon={<Icon name={"onepassword"} type={"material-community"} size={20} color={"white"}/>  }
        color={COLORS.orange}
        onPress={() => {
          console.log(userInfo)
          console.log(avatar)
